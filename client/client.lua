    ...
    K9Dawgs[#K9Dawgs + 1] = {
        ...
        params = {
            ...
            args = {
                ...
                patch = Config.DogModelProps[k]["Patch"],
            }
        }
    }
end
...
RegisterNetEvent('qb-k9:client:SpawnHandler', function(data) 
  TriggerServerEvent("K9:SERVER:SPAWN_K9", data.model, data.colour, data.vest, data.patch)
end)

--- SPAWN EVENT
RegisterNetEvent('K9:CLIENT:SPAWN_K9', function(DawgHash, colour, vest, patch)
  ...
  SetPedComponentVariation(DOG, 3, 0, vest, 2)
  SetPedComponentVariation(DOG, 8, 0, patch, 2)
...
RegisterKeyMapping('caninecommanders', 'K9 COMMANDS', 'keyboard', 'K')
...
RegisterKeyMapping('cannineattackfollow', 'K9 COMMANDS', 'keyboard', 'Z')
